...
void CubeOrientation::InitOrientation(int inputCube[N+2][N+2][N+2], int q) {
  ...
  for (int i = -2; i <= 2; i++) {
    for (int j = -2; j <= 2; j++) {
      for (int k = -2; k <= 2; k++) {
        Cub[i+2][j+2][k+2] = inputCube[i+2][j+2][k+2];
      }
    }
  }
  for (int i = 1; i <= q; i++) {
...
const bool CubeOrientation::XML(int a, bool n = true)
{
...
const bool CubeOrientation::XMR(int a, bool n = true)
{
  if (a < 1 || a > N) return false;
  Ctemp();
  for (int i = 1; i <= N; i++) {
...
const bool CubeOrientation::XMU(int a, bool n = true)
{
  if (a < 1 || a > N) return false;
  Ctemp();
  for (int i = 1; i <= N; i++) {
...
const bool CubeOrientation::XMD(int a, bool n = true)
{
  if (a < 1 || a > N) return false;
  Ctemp();
  for (int i = 1; i <= N; i++) {
...
const bool CubeOrientation::XMC(int a, bool n = true)
{
  if (a < 1 || a > N) return false;
  Ctemp();
  for (int i = 1; i <= N; i++) {
...
const bool CubeOrientation::XMA(int a, bool n = true)
{
  if (a < 1 || a > N) return false;
  Ctemp();
  for (int i = 1; i <= N; i++) {
...
const void CubeOrientation::UL() { XML(N); } // rotate top left
const void CubeOrientation::UR() { XMR(N); } // rotate top right
const void CubeOrientation::DL() { XML(1); } // rotate bottom left
const void CubeOrientation::DR() { XMR(1); } // rotate bottom right
const void CubeOrientation::LU() { XMU(1); } // rotate left up
const void CubeOrientation::LD() { XMD(1); } // rotate left down
const void CubeOrientation::RU() { XMU(N); } // rotate right up
const void CubeOrientation::RD() { XMD(N); } // rotate right down
const void CubeOrientation::FC() { XMC(1); } // rotate front clockwise
const void CubeOrientation::FA() { XMA(1); } // rotate front anticlockwise
const void CubeOrientation::BC() { XMC(N); } // rotate back clockwise (looking from front)
const void CubeOrientation::BA() { XMA(N); } // rotate back anticlockwise (looking from front)
const void CubeOrientation::ML() { XML(2); } // rotate middle left
const void CubeOrientation::MR() { XMR(2); } // rotate middle right
const void CubeOrientation::MU() { XMU(2); } // rotate middle up
const void CubeOrientation::MD() { XMD(2); } // rotate middle down
const void CubeOrientation::MC() { XMC(2); } // rotate middle clockwise
const void CubeOrientation::MA() { XMA(2); } // rotate middle anticlockwise
const void CubeOrientation::CL() { for (int i = 1; i <= N; i++) XML(i); } // rotate whole cube left
const void CubeOrientation::CR() { for (int i = 1; i <= N; i++) XMR(i); } // rotate whole cube right
const void CubeOrientation::CU() { for (int i = 1; i <= N; i++) XMU(i); } // rotate whole cube up
const void CubeOrientation::CD() { for (int i = 1; i <= N; i++) XMD(i); } // rotate whole cube down
const void CubeOrientation::CC() { for (int i = 1; i <= N; i++) XMC(i); } // rotate whole cube clockwise
const void CubeOrientation::CA() { for (int i = 1; i <= N; i++) XMA(i); } // rotate whole cube anticlockwise
const void CubeOrientation::XCL() { for (int i = 1; i <= N; i++) XML(i, false); } // rotate whole cube left w/o altering centers
const void CubeOrientation::XCR() { for (int i = 1; i <= N; i++) XMR(i, false); } // rotate whole cube right w/o altering centers
const void CubeOrientation::XCU() { for (int i = 1; i <= N; i++) XMU(i, false); } // rotate whole cube up w/o altering centers
const void CubeOrientation::XCD() { for (int i = 1; i <= N; i++) XMD(i, false); } // rotate whole cube down w/o altering centers
const void CubeOrientation::XCC() { for (int i = 1; i <= N; i++) XMC(i, false); } // rotate whole cube clockwise w/o altering centers
const void CubeOrientation::XCA() { for (int i = 1; i <= N; i++) XMA(i, false); } // rotate whole cube anticlockwise w/o altering centers
// return adjacent axis on which given center is found
const int CubeOrientation::FindCent(int a)
{
...
const int CubeOrientation::FindEdge(int a, int b)
{
  int f = 0, x, y, z; fx = 0; fy = 0; fz = 0;
  for (int i = -1; i <= 1; i = i + 2) {
...
const int CubeOrientation::FindCorn(int a, int b, int c)
{
  int f = 0, x, y, z; fx = 0; fy = 0; fz = 0;
  for (int i = -1; i <= 1; i = i + 2) {
    for (int j = -1; j <= 1; j = j + 2) {
...
const string CubeOrientation::Concise(string a)
{
  // initialize stuff
  string s = a; string t = "";
...
const string CubeOrientation::Efficient(string a)
{
  string s = a;
...
// Top Edges (step 1)
const string CubeOrientation::TopEdges()
{
  string s = "";
...
// Top Corners (step 2)
const string CubeOrientation::TopCorners()
{
  string s = "";
  if (!cubeinit) return s;
...
// Middle Edges (step 3)
const string CubeOrientation::MiddleEdges()
{
  string s = "";
  if (!cubeinit) return s;
...
const string CubeOrientation::BottomEdgesOrient()
{
  string s = "";
  if (!cubeinit) return s;
...
const string CubeOrientation::BottomEdgesPosition()
{
  string s = "";
  if (!cubeinit) return s;
...
const string CubeOrientation::BottomCornersPosition()
{
  string s = "";
  if (!cubeinit) return s;
...
const string CubeOrientation::BottomCornersOrient()
{
  string s = "";
  if (!cubeinit) return s;
...
const string CubeOrientation::CentersRotate()
{
  string s = "";
  if (!cubeinit) return s;
  mov[8] = 0;
